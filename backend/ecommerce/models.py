...
class EcommerceProduct(models.Model):
    ...
    description = models.TextField(null=False)
    category_id = models.ForeignKey(EcommerceCategory, on_delete=models.CASCADE, related_name="orderitem")
    image = models.TextField(null=False)
    qty = models.IntegerField(null=False)

class EcommerceOrderItem(models.Model):
    product_id = models.ForeignKey(EcommerceProduct, on_delete=models.CASCADE, related_name="orderitem")
